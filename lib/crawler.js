...
export async function crawl(startUrl, options) {
    ...
    console.log('[crawler] Launching Chromium browser...');
    ...
    try {
        ...
        console.log(`[crawler] Starting crawl loop. Queue size: ${queue.length}, maxPages: ${maxPages}`);
        while (queue.length > 0 && pages.length < maxPages) {
            ...
            try {
                ...
                console.log(`[crawler] Successfully loaded ${url}`);
            } catch (err) {
